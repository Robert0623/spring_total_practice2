...
public class UserDaoImplTest {
    ...
    public void insertUser() throws Exception {
        ...
        assertTrue(userDao.insert(user3)==1);
        assertTrue(userDao.count()==2);

        // 같은 데이터를 2번 입력하고 예외가 발생하는지 테스트
        userDao.insert(user);  // java.sql.SQLIntegrityConstraintViolationException예외발생. Duplicate entry 'asdf' for key 'PRIMARY'
    }
